<%-- 
    Document   : index
    Created on : 14/06/2021, 05:55:39 PM
    Author     : sergi
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="resources/css/kendo.default.mobile.min.css" />
    ...
    <body>
        <div id= "video">
            <div id= "logo"> 
                <img src="imagenes\logo_transparent1.png" width="70%" height="70%" style="display:block; margin-top: 1%; margin-left: 50%;" />
            </div>
            <div id="multimedia"> 
        ...
        <div class="form">
            ...
            <div class="demo-section k-content">
                ...
                <p>
                    <a href="resources/bienvenida.jsp"><button id="BotonIS" class="primary">Iniciar sesion Semillero</button></a>
                </p>
                <p>
                    <a href="resources/admin.jsp"><button id="BotonIS" class="primary">Iniciar sesion Admin</button></a>
                </p>
                <p>
