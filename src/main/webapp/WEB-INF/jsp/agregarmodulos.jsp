<%-- 
    Document   : agregarmodulos
    Created on : 16-jul-2021, 17:04:43
...
<body class="body1">
        ...
        <div class="container">
        <h1><center><font color="#fff">Crear modulos</font></h1></center>
        <br>
            <div class="row">
                <div class="col-md-12 col-lg-12"  >
                    <table cellspacing="6" class="table table-dark" id="myTable" style="border-radius: 15px;" >
        ...
        <script type="text/javascript">
            $(function () {
                $("#myTable").dynamicTable({
                    ...
                    data: [{
                            name: 'Aquí aparecerá el nombre de tu curso',
                            descripcion: 'detalla la instrucción de tu curso en general ', 
                            button:"Aqui subiras archivos",
                        },
                    ...
                    getControl: function (columnKey) {
                        ...
                        if (columnKey == "button") {
                            return ' <span class="btn btn-primary btn-file">Subir archivo <input type="file"></span>';
                        }
