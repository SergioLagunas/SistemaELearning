    ...
    <body>
        ...
        <div class="form">
            ...
            <div class="demo-section k-content">
                ...
                <p>
                    <a href="bienvenida.jsp"><button id="BotonIS" class="primary">Iniciar sesion Semillero</button></a>
                </p>
                <p>
                    <a href="admin.jsp"><button id="BotonIS" class="primary">Iniciar sesion Admin</button></a>
                </p>
                <p>
